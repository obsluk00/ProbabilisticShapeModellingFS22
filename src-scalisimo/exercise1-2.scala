...
/**
 * For each mesh we take the corresponding landmarks and align these landmarks to the reference landmarks. We save the transformation in a variable.
 * We now apply the transformation onto the entier mesh.
 */
